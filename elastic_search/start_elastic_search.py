...
def start_elastic_search(host="localhost", port=9201, container_name="es_temp"):
    ...
    return es, started_container

def close_elastic_search(es, started_container, container_name="es_temp"):
    es.close()
